...
public class Ordenar extends JFrame {
	...
	public Ordenar() {
		 ...
		 */
		JButton btnCargar = new JButton("Ordenar por ID");
		btnCargar.setIcon(new ImageIcon(Ordenar.class.getResource("/imagenes/icons8-estructura-de-precios-filled-100.png")));
